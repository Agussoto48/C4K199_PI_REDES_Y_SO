...
int main() {
    ...
    //Dragon
    const int CANT_PIEZAS_DRAGON = 200;
    ...
    figura.Inicializar(9, "dragon", 1, CANT_PIEZAS_DRAGON);

    for (int i = 0; i < CANT_PIEZAS_DRAGON; i++) {
    ...
    cout << (resultado == 0 ? 
        "Insertada figura dragon mitad 1" : 
        "Error insertando dragon mitad 1") << endl;
    
    
    figura.Inicializar(10, "dragon", 2, CANT_PIEZAS_DRAGON);
    ...
    cout << (resultado == 0 ? 
        "Insertada figura dragon mitad 2" : 
        "Error insertando dragon mitad 2") << endl;
