...
/**
 * Programa de prueba para crear el sistema de archivos lego.dat
 * y cargar varias figuras de ejemplo en el directorio.
 *
 * Crea el archivo del sistema, lo abre, inserta varias figuras
 * con sus piezas y finalmente muestra el contenido almacenado.
 *
 * @return 0 si la ejecucion fue exitosa, 1 en caso de error.
 */
int main() {
    SistemaArchivos fs;
    Figura figura1;
    ...
    // creaa archivo del sistema de archivos
