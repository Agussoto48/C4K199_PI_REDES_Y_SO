...
class SistemaArchivos {
   ...
   public:
      ...
      /*
       * Nuevas funciones para servidor HTTP
       */
      string ConstruirTextoListadoFiguras();
      string ConstruirTextoFigura(const char* nombre, int mitad);

      string ConstruirRespuestaHTTP200(const string& cuerpo);
      string ConstruirRespuestaHTTP404(const string& cuerpo);
      string ConstruirRespuestaHTTP400(const string& cuerpo);

      string ConstruirRespuestaHTTPListado();
      string ConstruirRespuestaHTTPFigura(const char* nombre, int mitad);
};
