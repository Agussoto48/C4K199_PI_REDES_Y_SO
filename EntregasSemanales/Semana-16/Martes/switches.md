...
Las conecto en los primeros 10 puertos. Luego, en cada computadora, hago:
...
## Si se quisiera configurar otra isla
...
## Conectar los L2 al L3

El primer l2 tiene una conexion que sale del puerto 11 y llega al puerto 1 del L3.

El segundo l2 tiene una conexion que sale del puerto 11 y llega al puerto 2 del L3.

El tecer  l2 tiene una conexion que sale del puerto 11 y llega al puerto 3 del L3.
